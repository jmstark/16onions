 ...
 * @author totakura
 */
public class OnionAuthCipherEncryptRespTest {
    ...
    private final OnionAuthCipherEncryptResp message;

    public OnionAuthCipherEncryptRespTest() throws MessageSizeExceededException {
        message = new OnionAuthCipherEncryptResp(requestID, payload);
    }
    ...
    public void testParse() throws Exception {
        ...
        OnionAuthCipherEncryptResp expResult = message;
        buffer.clear();
        message.send(buffer);
        buffer.flip();
        buffer.position(4);
        OnionAuthCipherEncryptResp result = OnionAuthCipherEncryptResp.parse(buffer);
