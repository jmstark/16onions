...
public class OnionConnectingSocket extends OnionBaseSocket {
	...
	public void beginAuthentication(byte[] hopHostkey, int numLayers) throws TunnelCrashException
	{
		...
		catch (IOException | InterruptedException | IllegalIDException | OnionAuthErrorException | AuthApiException
				| IllegalAddressException | SizeLimitExceededException e) {
	...
	public int finishAuthentication(byte[] hopHostkey, int numLayers) throws TunnelCrashException {
		...
		} catch (IllegalAddressException | IllegalIDException | InterruptedException | AuthApiException e) {
			General.error("Tunnel construction failed");
			General.fatalException(e);
			throw new TunnelCrashException();
		}
	...
	public void destroy(){
		...
		catch(AuthApiException | IllegalAddressException | InterruptedException | IOException | SizeLimitExceededException | IllegalIDException e)
		{
	...
	public boolean getAndProcessNextDataMessage() {
		...
		catch(IllegalIDException | TunnelCrashException | AuthApiException | IllegalAddressException | InterruptedException e)
		{
